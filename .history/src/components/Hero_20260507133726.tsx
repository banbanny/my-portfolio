...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden" style={{ background: "#1B1919", minHeight: "100vh" }}>
      ...
      {/* PHOTO — hidden on mobile, visible md+ */}
      <div className="hidden md:block absolute bottom-0 right-0 md:right-[8%] hero-photo"
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 90%, #1B1919 100%)" }} />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-6 w-full flex flex-col justify-center" style={{ minHeight: "100vh", zIndex: 2 }}>
        <div className="max-w-lg pt-24 md:pt-28">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-6 text-xs text-gray-400 tracking-widest uppercase hero-tags"
