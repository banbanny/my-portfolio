...
interface Project {
  id: number; title: string; type: ProjectType; description: string; thumbnail: string; link: string;
}

const projects: Project[] = [
  { id: 1, title: "Victory Chapel Christian Center - Church Website", 
    type: "web", description: "This website serves as the official online platform of the church, providing a welcoming space where members and visitors can learn more about the church's mission, beliefs, and community.", thumbnail: "/vccc-thumbnail.jpg", link: "https://vccc-website-one.vercel.app/" },
  { id: 2, title: "Functional Portfolio Website", type: "web", description: "A fully functional and working portfolio website built with Next.js, showcasing projects, skills, and contact information in a sleek and modern design.", thumbnail: "/web-port.png", link: "https://web-portfolio-ruby-pi.vercel.app/" },
  { id: 3, title: "Portfolio Website Design", type: "figma", description: "UI/UX design for a Portfolio.", thumbnail: "/figma1.png", link: "https://www.figma.com/file/your-file-id" },
  { id: 4, title: "Victory Chapel Christian Center - Church Website", type: "figma", description: "A church website", thumbnail: "/vccc.png", link: "https://www.figma.com/file/your-file-id-2" },
  { id: 5, title: "5CRG Inventory Management System", type: "figma", description: "Inventory Management System for 5CRG.", thumbnail: "/figma3.png", link: "https://www.figma.com/file/your-file-id-2" },
  { id: 6, title: "Brand Identity", type: "graphics", description: "Logo and branding for a local business.", thumbnail: "/thumbnails/graphics1.png", link: "https://www.behance.net/ivanneobediente23" },
  { id: 7, title: "Poster Design", type: "graphics", description: "Event poster with bold typography and layout.", thumbnail: "/thumbnails/graphics2.png", link: "https://www.behance.net/your-project-2" },
];
...
const typeConfig: Record<ProjectType, { label: string; badge: string }> = {
  web:      { label: "Web and App Project",  badge: "#d11414" },
  ...
  return (
    <div ref={ref} style={{ opacity: inView ? 1 : 0, transform: inView ? "translateY(0)" : "translateY(32px)", transition: `opacity 0.55s ease ${index * 0.08}s, transform 0.55s ease ${index * 0.08}s` }}>
      <a href={project.link} target="_blank" rel="noopener noreferrer"
        ...
        style={{ display:"block", borderRadius:"12px", overflow:"hidden", border:`1px solid ${hovered ? "rgba(244,52,52,0.45)" : "rgba(244,52,52,0.15)"}`, background: hovered ? "rgba(244,52,52,0.06)" : "rgba(255,255,255,0.03)", transform: hovered ? "translateY(-5px)" : "translateY(0)", transition:"all 0.3s cubic-bezier(0.34,1.56,0.64,1)", cursor:"pointer", textDecoration:"none" }}>
        <div style={{ position:"relative", width:"100%", aspectRatio:"16/9", overflow:"hidden" }}>
          ...
          <img src={project.thumbnail} alt={project.title} style={{ position:"relative", zIndex:1, width:"100%", height:"100%", objectFit:"contain", transform: hovered ? "scale(1.04)" : "scale(1)", transition:"transform 0.5s ease", display:"block" }}
            onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; const p = (e.target as HTMLImageElement).parentElement; if (p) p.style.background = "#2a2222"; }} />
