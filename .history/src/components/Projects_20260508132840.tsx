          ...
          <div style={{ position:"relative", marginBottom:"20px" }}>
            <div className="be-logo-wrap">
             <svg width="88" height="88" viewBox="0 0 24 24" fill="white" style={{ margin:"0 auto", display:"block" }} aria-label="Behance">
                    ...
                    .601-1.763.601-.49 0-.912-.086-1.267-.258a2.62 2.62 0 01-.874-.672 2.713 2.713 0 01-.506-.94 3.745 3.745 0 01-.158-.995h6.857c.028-.632-.037-1.229-.194-1.79a4.151 4.151 0 00-.732-1.457 3.47 3.47 0 00-1.26-.98c-.508-.24-1.1-.36-1.775-.36-.618 0-1.185.114-1.703.342a3.98 3.98 0 00-1.317.933 4.194 4.194 0 00-.849 1.399c-.2.534-.3 1.112-.3 1.733 0 .64.096 1.225.286 1.754.19.53.468.984.832 1.364.363.38.808.672 1.333.879.525.207 1.124.31 1.8.31.882 0 1.629-.207 2.24-.62.612-.413 1.029-1.06 1.253-1.942h-1.846c-.103.366-.346.65-.757 1.05l-.001-.001zm-1.643-5.026c.336 0 .636.057.9.17.263.113.487.268.67.464.184.197.322.427.415.692.093.265.143.549.15.85h-4.783c.05-.62.27-1.118.66-1.495.39-.376.896-.564 1.517-.564l-.529-.117z"/>
             </svg>
            </div>
          </div>
