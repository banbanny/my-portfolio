...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{ background: "#1B1919", minHeight: "100vh" }}
    >
      <style>{`
        @keyframes fadeInUp {
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 70% at 75% 60%, rgba(143,29,29,0.81) 0%, rgba(124,9,9,0.4) 40%, transparent 70%)",
      ...
      <div
        ...
        style={{ width: "420px", height: "85vh", zIndex: 1, opacity: mounted ? undefined : 0 }}
      >
        <Image
          src="/hero.png"
          fill
        ...
        <div
          ...
          style={{ background: "linear-gradient(to bottom, transparent 90%, #1B1919 100%)" }}
        />
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to right, #1B1919 0%, transparent 0%)" }}
        />
      </div>
      ...
      >
        <div className="max-w-lg pt-28">
          <h1
            className="font-black-roboto uppercase leading-none"
            style={{ fontSize: "clamp(1rem, 7vw, 7rem)" }}
          >
          ...
          <div
            className="flex items-center gap-3 mt-6 text-xs text-gray-400 tracking-widest uppercase hero-tags"
