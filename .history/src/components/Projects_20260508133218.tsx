...
function BehanceCard() {
  ...
  <path d="M6.5 11.5h2.6c.9 0 1.4-.4 1.4-1.2 0-.9-.5-1.3-1.5-1.3H6.5v2.5zm0 4h2.8c1 0 1.6-.5 1.6-1.4 0-1-.6-1.5-1.7-1.5H6.5V15.5zM15.5 10.5c-1.1 0-1.8.7-1.9 1.8h3.7c-.1-1.1-.7-1.8-1.8-1.8z"/>
  <path d="M0 0v24h24V0H0zm14 8h4v1h-4V8zM10 17H4V7h5.8c2 0 3.2.9 3.2 2.6 0 1-.5 1.8-1.4 2.2 1.2.4 1.9 1.3 1.9 2.6C13.5 16.1 12.1 17 10 17zm10-.5c-.5.8-1.4 1.3-2.8 1.4-1.2.1-2.2-.2-3-.9-.8-.7-1.2-1.8-1.2-3.2h6.3V14c0-1.3-.3-2.4-1-3.2-.7-.8-1.7-1.2-3-1.2-1.2 0-2.2.4-3 1.3-.8.9-1.2 2-1.2 3.3 0 1.4.4 2.5 1.2 3.3.8.8 1.9 1.2 3.2 1.2 2 0 3.3-.9 3.8-2.7H20c-.1.2-.1.3 0 .5z"/>
</svg>
            </div>
          </div>
