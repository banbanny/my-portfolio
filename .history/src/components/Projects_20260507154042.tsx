...
const projects: Project[] = [
  ...
  { id: 6, title: "Bra", type: "graphics", description: "Logo and branding for a local business.", thumbnail: "/thumbnails/graphics1.png", link: "https://www.behance.net/ivanneobediente23" },
