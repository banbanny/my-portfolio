...
const certifications = [
  ...
  { id: 2, label: "PHP with MySQL", issuer: "Udemy", year: "2024", image: "/cert2.jpg" },  { id: 4, label: "Introduction to Large Language Models", issuer: "Google", year: "2026", image: "/cert4.jpg" },
